...
public record Stage(String id, String name, String status,
                    long startTimeMillis, long endTimeMillis,
                    long pauseDurationMillis, long durationMillis) {
    ...
    public static Stage create(String id, String name, String status, long startTimeMillis, long endTimeMillis, long pauseDurationMillis, long durationMillis) {
        return new Stage(id, name, status, startTimeMillis, endTimeMillis, pauseDurationMillis, durationMillis);
    }
}
