...
package com.pdasilem.jenkins.rest.domain.system;
...
public record SystemInfo(String hudsonVersion, String jenkinsVersion, String jenkinsSession,
                         String instanceIdentity, String sshEndpoint, String server,
    ...
    public static SystemInfo create(String hudsonVersion, String jenkinsVersion, String jenkinsSession,
        ...
        return new SystemInfo(hudsonVersion, jenkinsVersion, jenkinsSession,
