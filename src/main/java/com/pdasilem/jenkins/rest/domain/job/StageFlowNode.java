...
public record StageFlowNode(String name, String status,
                            long startTimeMillis, long durationTimeMillis,
                            List<Long> parentNodes) {

    public StageFlowNode {
        parentNodes = parentNodes != null ? List.copyOf(parentNodes) : List.of();
    }
    ...
    public static StageFlowNode create(String name, String status, long startTimeMillis, long durationTimeMillis, List<Long> parentNodes) {
        return new StageFlowNode(name, status, startTimeMillis, durationTimeMillis, parentNodes);
    }
}
